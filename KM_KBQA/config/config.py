...
LIST_WORD_LIST = ['有', '哪些', '那些', '几个', '可以', '介绍', '列举', '哪几大', '多少家', '几家', '多少个', '所有', '大全', '各']
...
CQA_QUESTION_WORDS = ['怎么做', '怎么办', '怎样', '如何', '办理', '手续', '流程', '条件', '要做什么', '有哪些要求', '目的', '为什么', '靠什么', '原理', '原因',
                      '为何', '排名', '历史', '发展', '趋势', '怎么来的', '来源', '优点', '缺点', '优缺点', '特点', '区别', '相比', '比较', '前者', '后者',
                      '关系', '联系', '影响', '差值', '注意', '要求', '须知', '规则', '过程', '上飞机', '开飞机', '坐飞机', '需要', '可提供', '使用',
                      '积分', '补偿', '故障', '携带', '排名', '起源', '计算', '怎么算', '额度','赔偿', '乘坐', '何时能', '购买', '支付', '规定', '改票', '更改机票', '食宿', '吃', '早餐']
# 非民航问题关键词
